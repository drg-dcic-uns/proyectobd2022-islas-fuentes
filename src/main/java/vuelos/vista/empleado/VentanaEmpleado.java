...
public interface VentanaEmpleado extends Ventana {
	...
	/**
	 * Constante que identifica la opcion del menu que muestra los vuelos y permite
	 * realizar reservas
	 */
	...
	/**
	 * Muestra el panel (ventana) que corresponda a alguna de las opciones del menu
	 * principal
	 * 
	 * @param panel
	 */
	...
	/**
	 * Muestra la lista de vuelos disponibles para un viaje de IDA en la componente
	 * (tabla) dispuesta
	 * 
	...
	/**
	 * Muestra la lista de vuelos disponibles para un viaje de VUELTA en la
	 * componente (tabla) dispuesta
	 * 
	 * @param vuelosDisponibles
	 */
	...
	/**
	 * Muestra la lista de clases, asientos disponibles y precio en la tabla de
	 * detalle en Solo Ida
	 * 
	 * @param detalle
	 */
	...
	/**
	 * Muestra la lista de clases, asientos disponibles y precio en la tabla de
	 * detalle de Ida en los viajes de Ida y Vuelta
	 * 
	 * @param detalle
	 */
	...
	/**
	 * Muestra la lista de clases, asientos disponibles y precio en la tabla de
	 * detalle de Vuelta en los viajes de Ida y Vuelta
	 * 
	 * @param detalle
	 */
	 ...
	 * 
	 * @param esIdaVuelta indica si está en la reserva de SoloIda (false) o
	 *                    idaVuelta (true)
	 * @param pasajero
	 */
	...
	/**
	 * Muestra la pantalla final del proceso de reserva donde se muestran todos los
	 * datos de la reserva.
	 * 
	 * @param reserva
	 */
