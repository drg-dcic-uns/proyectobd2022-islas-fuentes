...
public interface ControladorVuelo {
	 ...
	 * 
	 * Se espera que esta acción se realice posteriormente de haber realizado una
	 * conexión exitosa.
	 */
	 ...
	 * 
	 * Informa al modelo para que realice la desconexión de la BD
	 * conexion.desconectarBD(); Realiza cualquier otro ajuste necesario (dispose de
	 * objetos) System.exit(0);
	 */
