...
public interface ControladorEmpleado extends ControladorVuelo {
	...
	/*
	 * Metodos que informan al controlador que debe mostrar una ventana en
	 * particular
	 */
	...
	/**
	 * Informa al controlador que se solicita mostrar información sobre los vuelos
	 * disponibles teniendo en cuenta las siguientes restricciones.
	 * 
	 * @param esIdaVuelta (requerido) indica si quiere ida y vuelta (true) o ida
	 *                    solo (false)
	 * @param fechaDesde  (requerido) vuelos que salgan en esta fecha
	 * @param fechaHasta  si es ida y vuelta esta fecha se utiliza para la vuelta
	 *                    (solo será requerido si es ida y vuelta)
	 * @param origen      (requerido) ubicación de origen para el vuelo de ida
	 * @param destino     (requerido) ubicación destino para el vuelo de ida (será
	 *                    origen del vuelo de vuelta)
	 */
	...
	/**
	 * Informa al controlador que se seleccionó un vuelo y se requiere obtener el
	 * detalle del mismo. La selección ocurre para un viaje de ida solamente.
	 * 
	...
	/**
	 * Informa al controlador que se seleccionó un vuelo y se requiere obtener el
	 * detalle del mismo La selección ocurre para un viaje de ida y vuelta sobre el
	 * vuelo de ida.
	 * 
	 * @param vueloSeleccion
	 */
	...
	/**
	 * Informa al controlador que se seleccionó una clase. La selección ocurre para
	 * un viaje de ida solamente.
	 * 
	 * @param detalle
	 */
	...
	/**
	 * Informa al controlador que se seleccionó una clase. La selección ocurre para
	 * un viaje de ida y vuelta sobre el vuelo de ida.
	 * 
	 * @param detalle
	 */
	...
	/**
	 * Informa al controlador que se seleccionó una clase. La selección ocurre para
	 * un viaje de ida y vuelta sobre el vuelo de vuelta.
	 * 
	 * @param detalle
	 */
	...
	/**
	 * Informa al controlador que se ha realizado la seleccion de vuelos que desea
	 * reservar.
	 * 
	...
	/**
	 * Informa al controlador que el usuario desea volver a la pantalla de selección
	 * de vuelos.
	 * 
	...
	/**
	 * Informa al controlador que el usuario desea confirmar los datos ingresados y
	 * realizar la reserva.
	 * 
	 * Los datos que se utilizan para la reserva son los internos que dispone el
	 * controlador.
	 */
	public void reservar();

	/**
	 * Ventana informa al controlador que hubo algun error en los datos que se
	 * esperaban para mostrar
	 * 
	 * @param msj
	 */
