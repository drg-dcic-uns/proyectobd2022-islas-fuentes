...
public class Fechas {
	...
	public static java.util.Date convertirStringADate(String p_fecha) throws Exception {
		...
		if (p_fecha != null) {
			try {
				...
				logger.error("Se produjo un error en la conversión del string {} a fecha mensaje {}", p_fecha,
						ex.getMessage());
	...
	public static String convertirStringSQL(String p_fecha) {
		if (p_fecha == null) {
			...
			return ("" + p_fecha.charAt(8) + p_fecha.charAt(9) + "/" + p_fecha.charAt(5) + p_fecha.charAt(6) + "/"
